...
teams = ['Wet Supremacy', 'Liquidate the Kulaks', 'Drip or Drown', 'www.damplips.com', 'Fifty Shades of Spray', 'Wet Kavanaugh', 'H2007', 'WETROBOOMIN', 'Drippy Lips', 'Teenage Mutant Ninja Squirters', 'Sheck Wetty', 'Bros Before Hose', 'Soggy Style', 'So Wet It Squirts', 'Hash Slinging Splashers', '5 3/4', 'The Squirters', 'Bubbleproof Boy Scouts', 'Drip Too Hard', 'How I Wet Your Mother', 'Wet Dreamz', 'Spray’s Anatomy', 'Little Squirters', 'Putting Out the Flame', 'Squirt Till You Hurt', 'Too Much Fun Makes Us Squirt', 'Go In Hard, Come Out Wet', 'School Squirters', 'Your Moms a Hose', 'Hose Your Daddy', 'Hoes Down', 'Erotic Aquatics', 'Smokin n Soakin', 'Alliance of Men Who Pee Sitting Down', 'K K Spray', 'Viagra Falls', 'Lean in my Water Cup', 'Oceans 5', 'Wetty or Not, Here We Come', 'Drippy on my Blicky Uh', 'Beach Bitches', 'Wet Privilege', 'NSINK', 'Splash n Dash', 'Drippie Redd', 'Fresh Squeezed Sea-men', 'THe tHirStY GOrLs', 'Yeah Ight', 'Tunde Destroyers', 'Super Splash Bros', 'Drip Drip Suck My Dick', 'Guns N Hoses', 'Adult Swim', 'Water Gate', 'H2Hoes', 'T.H.Sea', 'Wet n Wild', 'Keeping Up With The Karsplashians', 'Snoop Soggy Dog', 'Shores and Beaches', 'Brandi Love 2020', 'Wetflix and Spill', 'Jehovas Wetness']
